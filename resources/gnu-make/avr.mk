...
AS=avr-gcc
INCLUDE=-Iinclude/
CC_OPTS=-Wall --std=gnu99 -DF_CPU=16000000UL -O3 -funsigned-char -funsigned-bitfields  -fshort-enums -Wall -Wstrict-prototypes -mmcu=atmega2560 $(INCLUDE)  -D__AVR_3_BYTE_PC__
...
AVRDUDE_FLAGS += -D -q -V -C /usr/share/arduino/hardware/archlinux-arduino/avr/bootloaders/gemma/avrdude.conf #/usr/share/arduino/hardware/tools/avr/../avrdude.conf
